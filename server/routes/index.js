...
// API
// 管理时, 获取文章列表
router.get('/api/admin/topics', isLogin, (req, res) => {
    article.getAdminTopics(req, res)
})
// 管理时, 获取单篇文章
router.get('/api/admin/article', isLogin, (req, res) => {
...
// 管理时, 删除文章
router.get('/api/admin/article/delete', isLogin, (req, res) => {
    article.deleteArticle(req, res)
})
// 管理时, 恢复文章
router.get('/api/admin/article/recover', isLogin, (req, res) => {
...
// 前台浏览时, 获取文章列表
router.get('/api/frontend/topics', (req, res) => {
    article.getTopics(req, res)
})
// 前台浏览时, 获取单篇文章
router.get('/api/frontend/article', (req, res) => {
...
// 读取评论列表
router.get('/api/frontend/comment/list', (req, res) => {
